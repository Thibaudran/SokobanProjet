...
public class Game
{
	 ...
	 * 						the character is based in the area's targets.
	 * Game over : the player can choose if he want to replay the level 
	 * 			   or continue to the other one.
	 */
	
	public Game()
	{
		/* create table of 36 cases, 6x6
		 * Define the field, placing boxes and walls (=> to define the difficulty)
		 * and even targets area and character's site
		 */
